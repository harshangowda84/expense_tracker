...
class _SummaryTabState extends State<SummaryTab> with TickerProviderStateMixin {
  ...
  List<ExpenseTransaction> _getFilteredTransactions(List<ExpenseTransaction> transactions) {
    ...
    DateTime startDate;
    DateTime? endDate; // For "Last Week", "Last Month" etc.
    ...
    switch (selectedPeriod) {
      ...
      case 'Last Week':
        ...
        endDate = lastWeekEnd.add(const Duration(days: 1)); // Include last day
        break;
      case 'This Month':
  ...
  List<ExpenseTransaction> _getPreviousPeriodTransactions(List<ExpenseTransaction> transactions) {
    ...
    switch (selectedPeriod) {
      ...
      case 'Last Week':
        final lastWeekEnd = now.subtract(Duration(days: now.weekday));
        endDate = lastWeekEnd.subtract(const Duration(days: 6));
        startDate = endDate.subtract(const Duration(days: 7));
        break;
      case 'This Month':
        endDate = DateTime(now.year, now.month, 1);
      ...
      case 'Last Month':
        final lastMonth = now.month == 1 ? 12 : now.month - 1;
        final lastMonthYear = now.month == 1 ? now.year - 1 : now.year;
        endDate = DateTime(lastMonthYear, lastMonth, 1);
        startDate = DateTime(lastMonthYear, lastMonth - 1, 1);
        break;
      case 'Last 30 Days':
  ...
  Widget _buildCompactPeriodSelector() {
    ...
    final Map<String, IconData> periodIcons = {
      'This Week': Icons.calendar_view_week_rounded,
      'Last Week': Icons.calendar_view_week_outlined,
      'This Month': Icons.calendar_view_month_rounded,
      'Last Month': Icons.calendar_view_month_outlined,
      'Last 30 Days': Icons.event_note_rounded,
      'Last 3 Months': Icons.date_range_rounded,
      'Last 6 Months': Icons.date_range_outlined,
      'This Year': Icons.calendar_today_rounded,
      'Last Year': Icons.calendar_today_outlined,
    };
        ...
        child: Container(
          ...
          child: DropdownButtonHideUnderline(
            child: DropdownButton<String>(
              ...
              menuMaxHeight: 400, // Increased from 250 to accommodate more options
              style: TextStyle(fontFamily: 'Inter', 
  ...
  Widget build(BuildContext context) {
    return Consumer<DataProvider>(
      builder: (context, data, _) {
        ...
        final cardUtilization = totalCreditLimit > 0 ? (totalCreditUsed / totalCreditLimit * 100) : 0.0;
              ...
              child: FadeTransition(
                ...
                child: Column(
                  ...
                  children: [
                    ...
                    // Credit Card Due Alert (if any)
                    if (upcomingDues.isNotEmpty) ...[
                      _buildCreditCardDueAlert(upcomingDues),
                      const SizedBox(height: 16),
                    ],
                    
                    // Main 4 metric cards in 2x2 grid - COMPACT
                    Expanded(
                      child: Column(
                        children: [
                          // Row 1: Income & Spent
                              ...
                              children: [
                                ...
                                Expanded(
                                  child: GestureDetector(
                                    ...
                                    child: _buildCompactMetricCard(
                                      title: 'Total Income',
                                      value: formatIndianAmount(totalIncome),
                                      subtitle: selectedPeriod.toLowerCase(),
                                ...
                                Expanded(
                                  child: GestureDetector(
                                    ...
                                    child: _buildCompactMetricCard(
                                      title: 'Total Spent',
                                      value: formatIndianAmount(totalSpent),
                                      subtitle: selectedPeriod.toLowerCase(),
                          ...
                          const SizedBox(height: 12),
                          // Row 2: Balance & Card Utilization
                          Expanded(
                            child: Row(
                              children: [
                                ...
                                Expanded(
                                  child: GestureDetector(
                                    ...
                                    child: _buildCompactMetricCard(
                                      ...
                                      value: formatIndianAmount(totalBalance),
                                      subtitle: 'Available in accounts',
                                ...
                                Expanded(
                                  child: GestureDetector(
                                    ...
                                    child: _buildCompactMetricCard(
                                      ...
                                      value: '${cardUtilization.toStringAsFixed(1)}%',
                                      subtitle: '${formatIndianAmount(totalCreditUsed)} of ${formatIndianAmount(totalCreditLimit)}',
                                      icon: Icons.credit_card,
                                      gradientColors: [Color(0xFF8B5CF6), Color(0xFF7C3AED)],
                                      iconBgColor: Color(0xFF8B5CF6),
                                      showUtilizationBar: true,
                                      utilizationPercent: cardUtilization,
                                    ),
                                  ),
                                ),
                              ],
              ...
              children: [
                ...
                Column(
                  ...
                  children: [
                    ...
                    // Utilization bar for card utilization
                    if (showUtilizationBar) ...[
                      const SizedBox(height: 8),
                      ClipRRect(
                        borderRadius: BorderRadius.circular(4),
